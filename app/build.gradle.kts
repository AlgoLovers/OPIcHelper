...
android {
    ...
    defaultConfig {
        ...
        testInstrumentationRunner = "com.na982.opichelper.HiltTestRunner"
        vectorDrawables {
    ...
    testOptions {
        unitTests {
            ...
            all {
                it.systemProperty("java.util.logging.config.file", "logging.properties")
                it.systemProperty("org.gradle.test.ignoreLogs", "true")
            }
        }
    }
    compileOptions {
