...
| `TtsPlaybackController.kt` | 재생 상태 관리 **인터페이스** | playQuestion/playAnswer/playMergedAudio. 4개 재생 StateFlow (isPlaying, isPaused, isQuestionPlaying, isAnswerPlaying). 하이라이트는 HighlightStateHolder에 위임. 구현체: `data/audio/TtsPlaybackControllerImpl` |
